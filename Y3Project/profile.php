   ...
   <?php  
		...
		<div class="message_post">
			<form action="" method="POST">
			   "<textarea name='message_body' id='message_textarea' placeholder='What do you want to say ?'></textarea>"
    ...
    <div class="modal-content">
      ...
      <form class="profile_post" action="" method="POST">
         <div class="form-group">
            <textarea class="form_control" name="post_body" id="" cols="30" rows="10"></textarea>
